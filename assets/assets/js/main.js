...
(function ($) {
  ...
  // Create a function to load the WhatsApp button
function loadWhatsAppButton() {
  // Create the WhatsApp button element
  var whatsappButton = document.createElement("a");
  
  // Configure the WhatsApp button
  whatsappButton.href = "https://api.whatsapp.com/send?phone=+31646976827";
  whatsappButton.target = "_blank";
  whatsappButton.innerHTML = '<i class="fab fa-whatsapp"></i> Chat met ons op WhatsApp';
...
// Call the function to load the WhatsApp button
loadWhatsAppButton();
